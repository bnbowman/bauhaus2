...
MIN_ALN_LENGTH = 100 # Should be larger, but test data was ~930 bp in size and wanted to keep that working.
...
makeReport <- function(report) {
  ...
  # Make Fishbone Plots
  makeFishbonePlots(errormodeList, report, minSample = 5)
