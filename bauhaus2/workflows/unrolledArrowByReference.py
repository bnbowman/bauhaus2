...
class UnrolledNoHQMappingWorkflow(Workflow):
    ...
    *ignored*, and the entire read sequence from the ZMW is used as a
    ...
    """
    WORKFLOW_NAME        = "UnrolledNoHQMappingArrowByReference"
    ...
    def plan(self):
        return ["summarize-mappings.snake", "scatter-constant-arrow-by-reference.snake", "heatmaps.snake", "locacc.snake", "uid-tag.snake"] + \
