...
Generate mapping reports workflow, starting from subreads.
  ...
  $ bauhaus2 --no-smrtlink --noGrid generate -w UnrolledNoHQMappingBurstyAlpha -t ${BH_ROOT}test/data/two-tiny-movies-unrolled-multiple-contigs.csv -o unrolled-mapping
