Test execution of the constant arrow for short movie workflow on some very tiny
...
Generate constant arrow for short movie workflow, starting from subreads.

  $ bauhaus2 --no-smrtlink --noGrid generate -w ConstantArrowForShortMovie -t ${BH_ROOT}test/data/two-tiny-movies.csv -o constantarrowforshortmovie
  Validation and input resolution succeeded.
  Generated runnable workflow to "constantarrowforshortmovie"

  $ (cd constantarrowforshortmovie && ./run.sh >/dev/null 2>&1)
