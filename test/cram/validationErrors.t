...
Missing mandatory p_ variables for CoverageTitration workflow
  ...
  $ bauhaus2 -m validate -w CoverageTitration -t ${BH_ROOT}test/data/lambdaAndEcoli.csv
...
Missing genome mask (CoverageTitration workflow)
  ...
  $ bauhaus2 -m validate -w CoverageTitration -t ${BH_ROOT}test/data/bad-cts/unrecognized-genome-mask.csv
